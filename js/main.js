document.addEventListener('DOMContentLoaded', function () {
  ...
  if (listEl && panelsEl) {
    const instruments = [
      { name:'Piano', tagline:'Technique. Expression. Musical Intelligence.', desc:"Piano students develop a strong foundation in technique, music reading, theory, repertoire and musical interpretation. Training is available from beginner level through structured certification preparation." },
      { name:'Violin', tagline:'Precision, Expression and Artistry.', desc:'Our violin programme develops proper posture, bow technique, intonation, rhythm, sight-reading and musical expression. Students are guided through progressive repertoire while building the discipline required for confident performance.' },
      ...
      { name:'Acoustic Guitar', tagline:'Build Your Technique. Find Your Sound.', desc:'Students learn chords, rhythm, picking, musical notation, repertoire and performance skills while developing a strong technical foundation.' },
      { name:'Electric Guitar', tagline:'Technique Meets Expression.', desc:'Our electric guitar programme develops technical control, rhythm, riffs, chords, scales, improvisation and performance skills across contemporary and structured musical styles.' },
      ...
      { name:'Vocals', tagline:'Develop Your Voice. Discover Your Artistry.', desc:'Our vocal programme develops the voice as an instrument — vocal technique, breath control, pitch, tone, resonance, expression, performance and repertoire, across contemporary and classical styles.' },
    ];
